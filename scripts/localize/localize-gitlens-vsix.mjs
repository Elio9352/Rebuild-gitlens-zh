...
const exactTranslations = new Map(
	Object.entries({
		...
		// 工作树 相关
		'Copy Working Changes to 工作树...': '复制工作区更改到工作树...',
		'Checkout Pull Request in 工作树 (GitLens)...': '在工作树中检出拉取请求 (GitLens)...',
		'Git Create 工作树...': 'Git 创建工作树...',
		'Git Delete 工作树...': 'Git 删除工作树...',
		'Git Open 工作树...': 'Git 打开工作树...',
		'Create 工作树...': '创建工作树...',
		'Delete 工作树...': '删除工作树...',
		'Delete 工作树s...': '删除工作树...',
		'Open 工作树': '打开工作树',
		'Open 工作树 File': '打开工作树文件',
		'Open 工作树 in New Window': '在新窗口中打开工作树',
		'Open 工作树s in New Window': '在新窗口中打开工作树',
		'Open in 工作树': '在工作树中打开',
		工作树: '工作树',
		// 工作树 相关
		'Compare 工作树 to Common Base': '比较工作树与公共基准',
		'Compare 工作树 to Here': '比较工作树与此处',
		'Compare 工作树 with': '比较工作树与',
		'Compare with 工作树': '与工作树比较',
		'Compare Ancestry with 工作树': '比较工作树公共基准',
		'Open All Changes with 工作树': '使用工作树打开所有更改',
		'Open All Changes with 工作树 Individually': '分别使用工作树打开所有更改',
		'Open All Changes with 工作树': '使用工作树打开所有更改',
		'Open All Changes with 工作树 Individually': '分别使用工作树打开所有更改',
		'Directory Compare 工作树 with Here': '目录比较工作树与此处',
		'Directory Compare with 工作树': '将目录与工作树比较',
		'Set Branch Comparison to 工作树': '与工作树比较',
		// Path 相关
		'Copy Path': '复制路径',
		'Copy Paths': '复制路径',
		...
		'Undo Commit on 工作树': '撤销工作树上的提交',
		// Filter 相关
		'Filter Repositories...': '筛选仓库...',
		'Clear Author Filter': '清除作者筛选',
		// 其他操作
		'Git Copy Working Changes to 工作树...': 'Git 复制工作区更改到工作树...',
		...
		'Hide 工作树s': '隐藏工作树',
		'Show 工作树s': '显示工作树',
		'Group 工作树s View': '分组工作树视图',
		'Detach 工作树s View': '分离工作树视图',
		'Hide 工作树s View': '隐藏工作树视图',
		'Show 工作树s View': '显示工作树视图',
		'工作树s View Options': '工作树视图选项',
...
const phraseTranslations = [
	...
	['All Changes with 工作树 Individually', '分别使用 工作树 打开所有更改'],
	['All Changes with 工作树', '使用 工作树 打开所有更改'],
	['All Changes', '所有更改'],
	['Common Base', '公共基准'],
	['Current Branch', '当前分支'],
	...
	['Open All Changes with 工作树 Individually', '分别使用 工作树 打开所有更改'],
	['Open All Changes with 工作树', '使用 工作树 打开所有更改'],
	['Copy Working Changes to 工作树', '复制工作区更改到 工作树'],
	['Checkout Pull Request in 工作树', '在 工作树 中签出拉取请求'],
	['Compare 工作树 to Common Base', '将 工作树 与公共基准比较'],
	['Compare 工作树 to Here', '将 工作树 与此处比较'],
	['Directory Compare 工作树 to Here', '将目录中的 工作树 与此处比较'],
	['Compare with 工作树', '与 工作树 比较'],
	['Git Create 工作树', 'Git 创建 工作树'],
	['Git Delete 工作树', 'Git 删除 工作树'],
	['Git Open 工作树', 'Git 打开 工作树'],
	['Create 工作树', '创建 工作树'],
	['Delete 工作树', '删除 工作树'],
	['Open 工作树', '打开 工作树'],
	['Create Patch', '创建补丁'],
...
function tidyTranslatedText(value) {
	return normalizePreservedTerms(value
		...
		.replace(/\bwith 工作树\b/g, '使用 工作树')
		.replace(/\bWorking 更改\b/g, '工作区更改')
		.replace(/\b工作树 View\b/g, '工作树s 视图')
		.replace(/\b工作树 view\b/g, '工作树s 视图')
		.replace(/\b工作树s View\b/g, '工作树s 视图')
		.replace(/\b工作树s view\b/g, '工作树s 视图')
		...
		.replace(/\bCompares 当前行 提交 使用工作树\b/g, '将当前行提交与 工作树 比较')
...
function cleanupResidualVisibleEnglish(value) {
	return value
		...
		.replace(/指定是否try collapse 打开 工作树s into single \(common\) 仓库在视图当possible/g, '指定是否在可行时，将打开的 工作树s 折叠为单个公共仓库显示在视图中')
		...
		.replace(/工作树s 是 not supported by 你的 version 的 Git/g, '你的 Git 版本不支持 工作树s')
		...
		.replace(/Selects working 更改 \(WIP\) 行当存在未提交更改，otherwise selects HEAD 行/g, '存在未提交更改时选择 工作树 更改（WIP）行，否则选择 HEAD 行')
		...
		.replace(/显示 工作树 分支作为树形当names contain slashes (__GL_PROTECTED_\d+__)/g, '当名称包含斜杠 $1 时，以树形显示 工作树 分支')
		...
		.replace(/指定是否reveal 工作树s在 _工作树s_ 视图，otherwise they revealed在 _仓库_ 视图/g, '指定是否在 _工作树s_ 视图中显示 工作树s，否则在 _仓库_ 视图中显示')
		.replace(/指定默认路径在哪些新版 工作树s 将 created/g, '指定创建新版 工作树s 时使用的默认路径')
		.replace(/指定如何和当打开 工作树 之后它 created/g, '指定创建 工作树 后如何以及何时打开它')
		.replace(/Always 打开新版 工作树 在当前窗口/g, '始终在当前窗口打开新版 工作树')
		.replace(/Always 打开新版 工作树 在新版 window/g, '始终在新窗口打开新版 工作树')
		.replace(/Never 打开新版 工作树/g, '从不打开新版 工作树')
		.replace(/Always 提示打开新版 工作树/g, '始终提示是否打开新版 工作树')
		...
		.replace(/指定是否include working 树形文件状态每个仓库在 _云工作区_ 视图/g, '指定是否在 _云工作区_ 视图中为每个仓库包含 工作树 文件状态')
		...
		.replace(/排序 工作树s by 最近提交日期在 descending 顺序/g, '按最近提交日期降序排序 工作树s')
		.replace(/排序 工作树s by 最近提交日期在 ascending 顺序/g, '按最近提交日期升序排序 工作树s')
		.replace(/排序 工作树s by 名称在 ascending 顺序/g, '按名称升序排序 工作树s')
		.replace(/排序 工作树s by 名称在 descending 顺序/g, '按名称降序排序 工作树s')
		...
		.replace(/指定如何工作树s 排序/g, '指定 工作树s 如何排序')
		.replace(/\s+([，。；：）])/g, '$1')
...
function cleanupRestoredVisibleText(value) {
	return normalizePreservedTerms(value
		...
		.replace(/显示 工作树 分支作为树形当names contain slashes `\/`/g, '当名称包含斜杠 `/` 时，以树形显示 工作树 分支')
		.replace(/指定是否文件 histories 将显示提交从所有分支/g, '指定文件历史是否显示来自所有分支的提交')
		.replace(/指定默认路径在哪些新版 工作树s 将 created/g, '指定创建新版 工作树s 时使用的默认路径')
		.replace(/指定如何和当打开 工作树 之后它 created/g, '指定创建 工作树 后如何以及何时打开它')
		.replace(/Always 提示打开新版 工作树/g, '始终提示是否打开新版 工作树')
...
function finalizeVisibleText(value) {
	...
	text = text
		...
		.replace(/\bList\b/g, '列表')
		// 必须在 Tree 替换之前处理 工作树，避免被拆分
		.replace(/\b工作树\b/g, '工作树')
		.replace(/\b工作树\b/g, '工作树')
		.replace(/\b工作树s\b/g, '工作树')
		.replace(/\bTree\b/g, '树形')
		...
		.replace(/比较 工作树 公共基准/g, '比较工作树与公共基准')
		.replace(/比较 工作树 此处/g, '比较工作树与此处')
		.replace(/打开 所有更改 使用 工作树/g, '使用工作树打开所有更改')
		.replace(/打开 所有更改 使用 工作树，分别/g, '分别使用工作树打开所有更改')
...
const configurationDescriptionOverrides = new Map(
	Object.entries({
		...
		'gitlens.views.repositories.includeWorkingTree': '指定是否在 _仓库_ 视图中为每个仓库包含 工作树 文件状态。',
...
const commandTitleOverrides = new Map(
	Object.entries({
		...
		'gitlens.views.reveal工作树InExplorer': '在文件资源管理器中显示',
		...
		'gitlens.graph.reveal工作树InExplorer': '在文件资源管理器中显示',
...
function getViewsWelcomeOverride(welcome) {
	...
	if (contents.includes('工作树s') && (contents.includes('not supported') || contents.includes('recent version'))) {
		return '⚠ 你的 Git 版本不支持 工作树s。请升级到更新版本。';
	}
...
GitLens 是由 GitKraken 构建并维护的 VS Code 扩展，面向希望在编辑器中理解代码历史、追踪作者信息、管理分支与 PR、提升协作效率的开发者。本地化版本已将安装元数据、命令、设置说明、视图、欢迎页、walkthrough、README、changelog 以及可安全替换的运行时 UI 文案改为简体中文。GitLens、Git、GitHub、GitLab、Bitbucket、Azure DevOps、Jira、VS Code、CodeLens、Blame、工作树s、PR、AI 等技术或产品名称保持原样。
...
- 许可证、第三方声明和法务文本
- GitLens、Git、GitHub、GitLab、Bitbucket、Azure DevOps、Jira、VS Code、CodeLens、Blame、工作树s、PR、AI 等技术或产品名称
`;
...
- GitLens、Git、GitHub、GitLab、Bitbucket、Azure DevOps、Jira、VS Code、CodeLens、Blame、工作树s、PR、AI 等技术或产品名称保持原样。
- 许可证和第三方声明保留官方原文。
...
const runtimeLiteralTranslations = new Map(
	Object.entries({
		...
		'All time': '全部时间',
		'Hold shift to compare with working tree': '按住 Shift 与 工作树 比较',
		Copy: '复制',
		Copied: '已复制',
		'Unable to Copy': '无法复制',
		...
		'Open 工作树': '打开 工作树',
		'Open 工作树 in New Window': '在新窗口中打开 工作树',
		'Open in 工作树s View': '在 工作树s 视图中打开',
		'Publish Branch': '发布分支',
		...
		'Add 工作树 to Workspace': '添加 工作树 到工作区',
		...
		'Choose 工作树 Folder': '选择 工作树 文件夹',
		'Choose a Different Root Folder for this 工作树': '为此 工作树 选择不同的根文件夹',
		'Choose a Pull Request...': '选择拉取请求...',
		'Choose a Specific Folder for this 工作树': '为此 工作树 选择特定文件夹',
		'Choose a Stash...': '选择贮藏...',
		'Conflicts Detected': '检测到冲突',
		'Copy Changes to 工作树': '复制更改到 工作树',
		'Copy Staged Changes to 工作树': '复制暂存更改到 工作树',
		'Create Pull Request Details (Preview)': '创建拉取请求详情（预览）',
		'Create Pull Request...': '创建拉取请求...',
		'Create 工作树 for Branch...': '为分支创建 工作树...',
		'Create 工作树 for Local Branch...': '为本地分支创建 工作树...',
		'Create 工作树 for New Local Branch...': '为新本地分支创建 工作树...',
		'Create 工作树 from Branch': '从分支创建 工作树',
		'Create 工作树 from Local Branch': '从本地分支创建 工作树',
		'Create 工作树 from New Branch': '从新分支创建 工作树',
		'Create 工作树 from New Local Branch': '从新本地分支创建 工作树',
		// Step 6.7: 批量追加 gitlens.js 高优先级翻译（批次2：30条）
		'Add on Workspace (Window) Open': '工作区（窗口）打开时添加',
		'Clone Repository...': '克隆仓库...',
		'Delete 工作树s': '删除 工作树s',
		'Deleted user': '已删除用户',
		'Directory Compare 工作树 With': '目录比较 工作树 与',
		'Directory Compare 工作树 with': '目录比较 工作树 与',
		"Don't Show Again": '不再显示',
		'Open All Changed Files': '打开所有更改的文件',
		'Open All Changes (difftool)': '打开所有更改（difftool）',
		'Open All Changes with 工作树': '打开与 工作树 的所有更改',
		...
		'Open Directory Compare with 工作树': '打开与 工作树 的目录比较',
		...
		'Changes were stashed, but the working tree cannot be updated because at least one file has staged and unstaged changes on the same line(s)': '更改已贮藏，但无法更新 工作树，因为至少一个文件在同一行有暂存和未暂存的更改',
		...
		'Choose a stash': '选择贮藏',
		'Choose a stash to apply to your working tree': '选择要应用到 工作树 的贮藏',
		...
		'File matches the working tree': '文件与 工作树 匹配',
		...
		'No working tree changes': '没有 工作树 更改',
		...
		'Open 工作树 in a New Window': '在新窗口打开 工作树',
		...
		'Select Branch to Create 工作树 From': '选择创建 工作树 的分支',
		'Select Existing Branch': '选择现有分支',
		'Select Repositories or 工作树s to Show': '选择要显示的仓库或 工作树s',
		...
		'Unable to apply stash. Your working tree changes would be overwritten. Please commit or stash your changes before trying again': '无法应用贮藏。你的 工作树 更改将被覆盖。请先提交或贮藏更改后重试',
		...
		'Unable to open compare. File has been deleted from the working tree': '无法打开比较。文件已从 工作树 中删除',
		...
		'Unable to open working file. File could not be found in the working tree': '无法打开工作文件。在 工作树 中找不到文件',
		...
		'Will stash uncommitted changes without changing the working tree': '将贮藏未提交的更改而不改变 工作树',
		'Will stash uncommitted changes, including untracked files': '将贮藏未提交的更改，包括未跟踪的文件',
		'工作树s minimize context switching by allowing simultaneous work on multiple branches': '工作树s 通过允许同时在多个分支上工作来最小化上下文切换',
		...
		'saves your local changes to a new stash and discards them from the working tree and index': '将本地更改保存到新贮藏并从 工作树 和索引中丢弃它们',
		...
		'Choose Folder': '选择文件夹',
		'Copy Working Changes to 工作树': '将工作区更改复制到 工作树',
		...
		'Execute action': '执行操作',
		'Cannot swap comparisons with the working tree': '无法交换与 工作树 的比较',
...
const runtimeFragmentTranslations = [
	...
	[
		...
		'选择创建新 工作树 所基于的分支${e.showTags?"或标签":""}',
	],
	// 选择器空结果与修订输入提示
	[
	...
	[
		'tooltip:"Branches"},{type:"remotes",icon:"gl-remotes-view",command:"gitlens.showRemotesView",tooltip:"Remotes"},{type:"stashes",icon:"gl-stashes-view",command:"gitlens.showStashesView",tooltip:"Stashes"},{type:"tags",icon:"gl-tags-view",command:"gitlens.showTagsView",tooltip:"Tags"},{type:"worktrees",icon:"gl-worktrees-view",command:"gitlens.show工作树sView",tooltip:"工作树s"}',
		'tooltip:"分支"},{type:"remotes",icon:"gl-remotes-view",command:"gitlens.showRemotesView",tooltip:"远程"},{type:"stashes",icon:"gl-stashes-view",command:"gitlens.showStashesView",tooltip:"贮藏"},{type:"tags",icon:"gl-tags-view",command:"gitlens.showTagsView",tooltip:"标签"},{type:"worktrees",icon:"gl-worktrees-view",command:"gitlens.show工作树sView",tooltip:"工作树"}',
	],
	...
	['label="Open 工作树"', 'label="打开 工作树"'],
	['alt-label="Open 工作树 in New Window"', 'alt-label="在新窗口中打开 工作树"'],
	['label="Open in 工作树s View"', 'label="在 工作树s 视图中打开"'],
	['>Publish Branch<', '>发布分支<'],
	...
	['aria-label="Show 工作树s view"', 'aria-label="显示 工作树s 视图"'],
	['content="Show 工作树s view"', 'content="显示 工作树s 视图"'],
...
const runtimeRegexTranslations = [
	...
	[
		flexRegExp('Powerful tools &mdash; Commit Graph, Visual History, &amp; Git 工作树s for private repos'),
		'强大工具 &mdash; 私有仓库可用的提交图、可视化历史与 Git 工作树s',
	],
	[
	...
	[/(\$\{t\.join\(", "\)\}) in the working tree/g, '工作树 中：$1'],
	// ===== 主页：合并目标状态 =====
	[
...
const settingsHtmlTextTranslations = new Map(
	Object.entries({
		...
		'Time&nbsp;format': '时间&nbsp;格式',
		'Default&nbsp;worktree&nbsp;location': '默认&nbsp;工作树&nbsp;位置',
		'Commit Graph&nbsp;': '提交图&nbsp;',
		'工作树s view&nbsp;': '工作树s 视图&nbsp;',
		'Example:': '示例：',
		'Example date:': '日期示例：',
		...
		'Example time:': '时间示例：',
			...
			'absolute path to put new worktrees into': '新 工作树 的绝对存放路径',
		...
		'Show the pull request associated with the current branch': '显示当前分支关联的拉取请求',
			'Show the pull request associated with the worktree branch': '显示 工作树 分支关联的拉取请求',
		...
		'Working tree file changes': '工作树 文件更改',
		...
		'Close Unchanged Files': '关闭未更改文件',
		'Open on Remote (Web)': '在远程打开（Web）',
		'Open 工作树 for Pull Request': '为拉取请求打开 工作树',
		'Copy As': '复制为',
		'Copy as Patch': '复制为补丁',
		'Copy Relative Path': '复制相对路径',
		'Share as Cloud Patch...': '共享为 Cloud Patch...',
		...
		'Always ask where to put new worktrees': '始终询问新 工作树 放置位置',
			'Current branch': '当前分支',
			'current branch': '当前分支',
			'working tree': '工作树',
			'false': 'false',
		...
		'to visualize, explore, and manage Git worktrees': '可视化、探索和管理 Git 工作树',
